...
const KUIViewer: ComponentType<KUIViewerProps> = dynamic(
  () => import('@kuraykaraaslan/kui-viewer/react').then((m) => m.KUIViewer),
  {
    ssr: false,
    loading: () => (
  ...
  return [
    {
      ...
      since: '2026-05',
      external: {
        packageName: '@kuraykaraaslan/kui-viewer',
        version: '0.0.8',
        homepage: 'https://kui-viewer.kuray.dev',
        npm: 'https://www.npmjs.com/package/@kuraykaraaslan/kui-viewer',
      ...
      dependencies: ['@kuraykaraaslan/kui-viewer', 'three', 'web-ifc', '@thatopen/fragments', 'zustand'],
