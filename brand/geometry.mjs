/**
 * The kui-react brand mark, as raw geometry.
 *
...
export const COLORS = {
  ...
  /** THE REACT KIT — the runtime this kit targets. It is also the family's own `--secondary`, the token this package defines for every sibling — the two kits are one library, and the second tone is what tells them apart at 16px. */
  toneTwo: "#8b5cf6",
...
export const WORDMARK = { lead: "kui", trail: " react" };
...
export const TAGLINE = "A modular React component library";
