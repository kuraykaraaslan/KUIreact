...
| second tone | `#8b5cf6` | **the React kit** — the runtime this kit targets. It is also the family's own `--secondary`, the token this package defines for every sibling — the two kits are one library, and the second tone is what tells them apart at 16px |
